package com.genersoft.iot.wvmp.vmanager.streampush;
...
import com.genersoft.iot.wvmp.conf.security.SecurityUtils;
import com.genersoft.iot.wvmp.conf.security.dto.LoginUser;
...
import com.genersoft.iot.wvmp.service.impl.StreamPushUploadFileHandler;
import com.genersoft.iot.wvmp.vmanager.bean.BatchGBStreamParam;
import com.genersoft.iot.wvmp.vmanager.bean.ErrorCode;
import com.genersoft.iot.wvmp.vmanager.bean.StreamPushExcelDto;
...
public class StreamPushController {
    ...
    @ResponseBody
    public DeferredResult<ResponseEntity<WvmpResult<Object>>> uploadChannelFile(@RequestParam(value = "file") MultipartFile file){

        // 最多处理文件一个小时
        DeferredResult<ResponseEntity<WvmpResult<Object>>> result = new DeferredResult<>(60*60*1000L);
        ...
        if (file.isEmpty()) {
            ...
            WvmpResult<Object> wvpResult = new WvmpResult<>();
            wvpResult.setCode(-1);
        ...
        try {
            ...
            ExcelReader excelReader = EasyExcel.read(inputStream, StreamPushExcelDto.class,
                    new StreamPushUploadFileHandler(streamPushService, mediaServerService.getDefaultMediaServer().getId(), (errorStreams, errorGBs)->{
                        ...
                        RequestMessage msg = new RequestMessage();
                        msg.setKey(key);
                        WvmpResult<Map<String, List<String>>> wvpResult = new WvmpResult<>();
