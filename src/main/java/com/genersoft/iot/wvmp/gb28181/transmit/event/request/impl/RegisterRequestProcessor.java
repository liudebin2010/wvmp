...
import com.genersoft.iot.wvmp.gb28181.bean.WvmpSipDate;
...
import com.genersoft.iot.wvmp.gb28181.auth.DigestServerAuthenticationHelper;
...
public class RegisterRequestProcessor extends SipRequestProcessorParent implements InitializingBean, ISipRequestProcessor {
    ...
    public void process(RequestEvent evt) {
        try {
            ...
            // 使用自己修改的
            WvmpSipDate wvmpSipDate = new WvmpSipDate(Calendar.getInstance(Locale.ENGLISH).getTimeInMillis());
            dateHeader.setDate(wvmpSipDate);
