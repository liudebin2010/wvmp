package com.genersoft.iot.wvmp.gb28181.protocol.playback;
...
public class PlaybackController {
	...
	public DeferredResult<WvmpResult<StreamInfo>> play(@PathVariable String deviceId, @PathVariable String channelId,
		...
		return playService.playBack(deviceId, channelId, startTime, endTime, null,
				playBackResult->{
					if (playBackResult.getCode() != ErrorCode.SUCCESS.getCode()) {
						...
						data.setData(WvmpResult.fail(playBackResult.getCode(), playBackResult.getMsg()));
